...
#| label: tbl-univariee
#| echo: false
#| tbl-cap: "Résultats de l'analyse univariée par régression logistique."
#| tbl-pos: "H"
...
#| echo: false
#| tbl-cap: "Modèle de régression logistique multivariée."
#| tbl-pos: "H"
...
t=tidy(mod, exponentiate = TRUE, conf.int = TRUE) %>%
  filter(term != "(Intercept)") %>%
  transmute(
    Variable = term,
